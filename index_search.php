    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by SUBRAMANYA T N" data-placement="bottom" target="">
                    Electricks.com.ph
                </a>
        ...
        <footer class="footer" data-background-color="black">
            <div class="container">
                ...
                <div class="copyright">
                    ...
                    </script>, Designed and Coded by SUBRAMANYA T N
                </div>
            </div>
        </footer>
    </div>
